...
public class UserDetailsDto {
	...
	@NotEmpty
	@Pattern(regexp = "^([A-Za-z]){5}([0-9]){4}([A-Za-z]){1}$",message= "Pan Number pattren should be like first 5 characters should be letters,followed by numerals, and the last character is the letter")
	...
	@Size(min=8,max=15,message ="Password size should be between 8 to 15")
	...
	@NotEmpty
	@Size(min=10,max=10,message ="Mobile Number size should be 10 digits")
