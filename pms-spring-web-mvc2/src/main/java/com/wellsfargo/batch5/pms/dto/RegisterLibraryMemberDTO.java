...
public class RegisterLibraryMemberDTO {
	...
	public RegisterLibraryMemberDTO() {
		
	}
	
	public RegisterLibraryMemberDTO(String userName, String password, String confimrPassword, String firstName,
