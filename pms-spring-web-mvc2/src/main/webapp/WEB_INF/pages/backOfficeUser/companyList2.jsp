		...
		<section class="container-fluid p-4">
			<h3>Company Details</h3>
			 ...
			 <c:out value = "${company.companyCode}"/>
			  <c:choose>
				<c:when test="${company.companyCode==null}">
			     ...
			     <table class="table table-bordered table-striped">
						...
						<tbody>
							  <tr>
									...
									<td>${company.companyOperations}</td>
									<td>${company.shareCount}</td>
									<td>${company.openSharePrice}</td>
									<td>${company.turnOver}</td>
									<td>
										<a href="/registerNewStock?companyCode=${company.companyCode}" class="btn btn-sm btn-info">
											Add Stock
										</a>
									</td>
								</tr>
