...
<html>
	<head>
		<title>Back Office User Registration Form</title>
	...
	<%--	<jsp:include page="/header"/> --%>
		...
		<h3>New Back Office User</h3>
			<div class="col-sm-5">
			<form:form action="addBackOfficeUser"
			...
			<a href="adminHomePage"><input type="button" value="Admin Home Page"></a>
			</div>
